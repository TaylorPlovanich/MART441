...
function handleChoice(choice) {
    ...
    if (options[choice]) {
        ...
        return { 
            ...
            options: ["Look around", "Open door"] // Show basic options if input is invalid
        };
    }
}
...
function updateOptions(newOptions) {
    ...
    newOptions.forEach(option => {
        ...
        li.onclick = function() {
            ...
            playGame(); // Trigger game function
        };
